          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column>
              <template slot-scope="scope">
                <div class="leftBox" @click="tongyong(scope.row.id)">
                  <div class="parkimg">
                  ...
                  <div class="leftBox-con">
                    ...
                    <div class="parkAddress">
                      <div class="dingwei">
                        <img src="../assets/images/positioning2.png" alt="" />
                      </div>
      ...
      <div class="right-con-right">
        ...
        <template>
          <el-table :data="parkList" stripe style="width: 100%">
            ...
            <!-- <el-table-column slot-scope="scope" v-if="scope.online == true" prop="在线" label="状态">在线</el-table-column>

            <el-table-column  v-else label="状态">离线 </el-table-column> -->
...
export default {
  ...
  methods: {
    tongyong(id) {
      ...
      // console.log(this.searhld)
      this.$axios
        .get(
          `/admin/api/station/${this.searhld}/chargers/?token=` +
            toKen +
            "&page=" +
            this.newpark +
            "&row=15"
...
.right-con-right[data-v-a0f591a0] {
  margin-top: 3%;
}
.right-con-left[data-v-a0f591a0] {
  margin-top: 3%;
}
.input_right {
  /* margin-left: -63px; */
